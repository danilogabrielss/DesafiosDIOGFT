...
public class Princ {
    public static void main(String[] args) {
        ...
        System.out.println("XP do aluno " + dev1.calcularTotalXp() +" e seu nivel é "+ dev1.getNivel());
        ...
        System.out.println("XP do aluno " + dev2.calcularTotalXp()  +" e seu nivel é "+ dev2.getNivel());
